...
<template>
  <SidebarProvider>
    <Sidebar collapsible="icon">
      <SidebarHeader class="flex flex-row items-center justify-between p-4">
        <SidebarMenu>
          <SidebarMenuItem
          ...
          <SidebarMenu>
            ...
            >
              <SidebarMenuItem class="">
                <SidebarMenuButton class="" :tooltip="item.title">
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem class="px-4 py-3 hover:cursor-pointer">
