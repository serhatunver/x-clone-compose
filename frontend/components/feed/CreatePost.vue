...
const submitPost = form.handleSubmit(async (values) => {
  ...
  try {
    ...
    form.resetForm();
    toast({
      title: props.isComment ? 'Your comment was sent.' : 'Your post was sent.',
      action: h(
        ToastAction,
        {
          altText: 'View',
          ...
          <FormItem>
            <FormControl>
              <Textarea
                ...
                :placeholder="
                  isComment ? 'Post your reply' : 'Share your thoughts...'
                "
          ...
          <div>
            ...
            >
              <template v-if="loading">
                <Icon name="svg-spinners:8-dots-rotate" size="18" />
